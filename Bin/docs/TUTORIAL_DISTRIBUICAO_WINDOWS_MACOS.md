...
```text
Bin/release/BaixadorDeVideos3000_Setup_Windows.exe
```

Para macOS, envie o ZIP do instalador automatico:

```text
Bin/release/BaixadorDeVideos3000_Instalador_macOS.zip
```

O pacote de codigo fonte fica em:

```text
Bin/release/Baixador_YTDLP_Windows_macOS.zip
```

Dentro dele, os arquivos principais ficam organizados assim:

- `Bin/python/src/ytdlp_gui_downloader.py`
...
- `Bin/launcher/Abrir_Baixador_YTDLP.bat`
- `Bin/launcher/Abrir_Baixador_YTDLP.vbs`
- `Bin/launcher/Abrir_Baixador_YTDLP.command`
- `Bin/scripts/Instalar_Dependencias_Windows.bat`
- `Bin/scripts/Instalar_Dependencias_macOS.command`
- `Bin/scripts/Sincronizar_Release_Servidor_Windows.bat`
- `README.md`
- `Bin/docs/update_manifest_example.json`
- `Bin/docs/argumentosExtras.txt`
...
Se aparecer `CERTIFICATE_VERIFY_FAILED` ou `unable to get local issuer certificate`, rode `Bin/scripts/Instalar_Dependencias_macOS.command` novamente e depois abra o app de novo.
  ...
  "files": [
    {
      ...
      "url": "https://SEU-SITE-OU-GITHUB/Bin/release/legacy/ytdlp_gui_downloader.py"
    },
    {
      "path": "Bin/python/src/ytdlp_gui_downloader.py",
      "url": "https://SEU-SITE-OU-GITHUB/Bin/python/src/ytdlp_gui_downloader.py"
    },
    {
      "path": "README.md",
    ...
    {
      "path": "Bin/python/requirements.txt",
      "url": "https://SEU-SITE-OU-GITHUB/Bin/python/requirements.txt"
    }
  ]
}
```
...
1. Edite o programa.
2. Aumente a versao dentro do arquivo `Bin/python/src/ytdlp_gui_downloader.py` e no `Bin/electron/package.json`:
...
Esse arquivo entra na pasta `Bin/electron/` automaticamente, verifica Node.js/npm, pergunta se pode instalar quando faltar, roda `npm install` e abre o app.
