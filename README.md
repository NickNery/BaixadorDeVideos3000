...
- `Bin/`: codigo, assets, docs, releases e launchers do aplicativo.
...
- `setup/`: instaladores principais para Windows e macOS.
...
```text
setup/Setup_BaixadorDeVideos3000_Windows.exe
```

macOS:

```text
setup/Setup_BaixadorDeVideos3000_macOS.command
```
...
Esse script copia `Bin`, `setup`, `README.md` e `update_manifest.json` para:
